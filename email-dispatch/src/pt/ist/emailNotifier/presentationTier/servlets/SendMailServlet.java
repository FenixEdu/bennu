...
public class SendMailServlet extends HttpServlet {
    ...
    //
    // Email email = createEmail(clientId, emailId, fromName, to, cc, bcc,
    // replyTo, subject, message);
    //
    // response.setContentType("text/plain");
    // outputStream.print(email.getExternalId());
    // outputStream.close();
    // return;
    // }
    //
    ...
    //
    // @Service
    // private Email createEmail(String clientId, String emailId, String
    // fromName, String to, String cc, String bcc, String replyTo,
    // String subject, String message) {
    //
    // ReceivedEmailRequest request = ReceivedEmailRequest.findRequest(clientId,
    // emailId);
    //
    // if (request != null) {
    ...
    //
    // Email email = new Email(fromName, "noreply@ist.utl.pt", replyToAddress,
    // Arrays.asList(toAddress), Arrays
