...
public class Sanitization {
    ...
    private static PolicyFactory TOOLKIT_SANITIZER = new HtmlPolicyBuilder()
            ...
            .globally()
            .allowAttributes("bennu-component", "component-resizable", "data-x", "data-y","data-height", "data-width", "data-source",
                    "data-metadata").onElements("div", "span", "a", "img", "h1", "h2", "h3", "h4", "h5", "h6", "p", "table")
