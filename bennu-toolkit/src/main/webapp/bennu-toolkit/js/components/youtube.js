(function () {
    ...
    function editor(element, handler) {
        ...
        let output = '<p class="help-block">Please choose <b>one</b> of these options:</p> <ul>' +
            '<li><p class="help-block">the video full link</p>' +
            '<p class="help-block">e.g. <b>https://youtu.be/Nmi4jKLTX9w</b></p></li> <li> <p class="help-block">the video ID </p>' +
            '<p class="help-block">e.g. <b>Nmi4jKLTX9w</b></p> </li> </ul>' +
            '<div class="form-group"><label class="col-sm-2 control-label">Link or ID</label><p></p>' +
            '<div class="col-sm-10"><input type="text" class="form-control" id="link" placeholder="https://youtu.be/Nmi4jKLTX9w">' +
            '</div></div><p></p><div class="form-group"><label class="col-sm-2 control-label">Width</label><div class="col-sm-4">' +
            ...
            '<label class="col-sm-2 control-label">Height</label><div class="col-sm-4">' +
