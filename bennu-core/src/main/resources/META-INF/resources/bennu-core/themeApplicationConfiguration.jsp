				...
				<td>
					<fr:edit name="virtualHostToConfigure" slot="layout">
						<fr:layout name="menu-select-postback">
							<fr:property name="providerClass" value="pt.ist.bennu.core.presentationTier.renderers.providers.LayoutProvider"/>
		...
		<table>
			<tr>
				...
				<td><fr:edit name="virtualHostToConfigure" slot="theme">
						<fr:layout name="menu-select-postback">
							<fr:property name="providerClass" value="pt.ist.bennu.core.presentationTier.renderers.providers.ThemeProvider"/>
							<fr:property name="eachLayout" value="values"/>
