...
public class ManageUsersAction extends ContextBaseAction {
    ...
    @CreateNodeAction(bundle = "MYORG_RESOURCES", key = "label.application.users.create.interface",
            groupKey = "label.application")
    public final ActionForward createManageCoffeeOrdersNode(final ActionMapping mapping, final ActionForm form,
            final HttpServletRequest request, final HttpServletResponse response) throws Exception {
        final VirtualHost virtualHost = getDomainObject(request, "virtualHostToManageId");
        final Node node = getDomainObject(request, "parentOfNodesToManageId");
        ActionNode.createActionNode(virtualHost, node, "/manageUsers", "searchUsers", "resources.MyorgResources",
                "label.application.users", UserGroup.getInstance());
    ...
    public ActionForward prepareCreateNewUser(final ActionMapping mapping, final ActionForm form,
            final HttpServletRequest request, final HttpServletResponse response) throws ClassNotFoundException {
        final SearchUsers searchUsers = new SearchUsers();
        request.setAttribute("searchUsers", searchUsers);
    ...
    public ActionForward forwardToSearchUser(final ActionMapping mapping, final ActionForm form,
            final HttpServletRequest request, final HttpServletResponse response) throws ClassNotFoundException {
        final User user = getDomainObject(request, "userId");
        final SearchUsers searchUsers = new SearchUsers();
        searchUsers.setUser(user);
