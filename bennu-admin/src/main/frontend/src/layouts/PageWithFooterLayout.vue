<template>
  <div
    ...
    ref="app"
    tabindex="-1"
    class="page-with-footer u-a11y-focusable"
  >
    <button
      class="skip-link"
    ...
    <progress-bar class="page-with-footer__progress-bar" />
    <feedback-top-bar />
    <header class="header-compact container">
      <router-link
        :to="{ name: 'LandingPage' }"
    ...
    <main
      ref="main"
      tabindex="-1"
      class="page-with-footer__main u-a11y-focusable"
    >
      <div class="container">
        <slot />
      </div>
    </main>
    <div class="page-with-footer__footer">
      <footer-compact />
    </div>
  </div>
</template>
...
.page-with-footer {
  ...
  .page-with-footer__progress-bar {
    top: 0;
  }
  ...
  .page-with-footer__main {
    width: 100%;
    align-self: center;
  }

  .page-with-footer__footer {
    margin-top: auto;
    display: flex;
