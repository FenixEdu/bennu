...
import pt.ist.bennu.core.domain.contents.legacy.INode;
 ...
 * 
 */
public abstract class LegacyContext extends DefaultContext {
    ...
    public LegacyContext(final String path) {
        this();
        setElements(path);
    }
    ...
    public Collection<INode> getMenuElements() {
        ...
        return (Collection) Node.getOrderedTopNodes(virtualHost);
    }
