...
public abstract class Node extends Node_Base implements INode {
    ...
    protected void appendNodePath(final StringBuilder stringBuilder) {
        ...
        if (parentNode != null) {
            ...
            stringBuilder.append(LegacyContext.PATH_PART_SEPERATOR);
        }
    ...
    public static Node getFirstAvailableTopLevelNode() {
        final Set<Node> nodes = Node.getOrderedTopNodes(VirtualHost.getVirtualHostForThread());
    ...
    public static SortedSet<Node> getOrderedTopLevelNodes() {
        ...
        return Node.getOrderedTopNodes(virtualHost);
    }
    ...
    @Deprecated
    public java.util.Set<pt.ist.bennu.core.domain.contents.legacy.Node> getChildNodes() {
        return getChildNodesSet();
    }

    public static SortedSet<Node> getOrderedTopNodes(VirtualHost virtualHost) {
